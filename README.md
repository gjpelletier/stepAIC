...
# stepAIC - Python function for stepwise regression to minimize AIC or BIC and eliminate non-significant predictors
...
Usin AIC as the criterion is the default in the stepAIC fuction. The user also as the option to use the BIC as the criterion instead. Using BIC is generally considered better than AIC for evaluation of stepwise regression for several reasons:
