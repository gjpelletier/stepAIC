...
The stepAIC algorothim has the option to use either a forward (default) or backward stepwise selection for the optimum set of predictor variables as follows:
