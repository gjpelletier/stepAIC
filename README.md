...
The stepAIC algorothim has the option to use either a forward (default), backward stepwise selection, or all combinations for the optimum set of predictor variables as follows:
