...
- All combinations evaluates all possible combinations of predictors to find the best of all possible models (requires no more than 20 candidate predictors)
