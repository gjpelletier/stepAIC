...
The stepAIC algorothim has the option to use either a forward (default), backward, or bi-directional stepwise search for the optimum set of predictor variables as follows:
