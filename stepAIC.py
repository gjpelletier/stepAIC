...
def linear_regression_stats_given_model(X,y,model):
...
def linear_regression_stats_given_y_pred(X,y,y_pred):
...
def lasso(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
    ...
    from stepAIC import linear_regression_stats_given_model, detect_dummy_variables
    import time
    import pandas as pd
    import numpy as np
    ...
    stats_cv = linear_regression_stats_given_model(X, y, model_cv)
    stats_lars_cv = linear_regression_stats_given_model(X, y, model_lars_cv)
    stats_aic = linear_regression_stats_given_model(X, y, model_aic)
    stats_bic = linear_regression_stats_given_model(X, y, model_bic)
...
def ridge(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
    ...
    from stepAIC import linear_regression_stats_given_model, vif_ridge, detect_dummy_variables
    import time
    import pandas as pd
    import numpy as np
    ...
    stats_aic = linear_regression_stats_given_model(X, y, model_aic)
    stats_bic = linear_regression_stats_given_model(X, y, model_bic)
    stats_vif = linear_regression_stats_given_model(X, y, model_vif)
