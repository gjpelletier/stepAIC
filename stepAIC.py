...
def stacking(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
        ...
        final_estimator= 'linear' (default), 'lasso', or 'elastic' 
            ...
            The default final regressor is ElasticNetCV
            'linear' = LinearRegression 
            'lasso' = LassoCV
            'elastic' = ElasticNetCV (default)
    ...
    if data['final_estimator']=='lasso':
        meta_regressor = LassoCV(random_state=data['random_state'])
    if data['final_estimator']=='elastic':
