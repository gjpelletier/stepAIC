...
def lasso(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
    ...
    stats_cv = linear_regression_stats(X, y, model_cv)
    stats_lars_cv = linear_regression_stats(X, y, model_lars_cv)
    stats_aic = linear_regression_stats(X, y, model_aic)
    stats_bic = linear_regression_stats(X, y, model_bic)
...
def ridge(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
    ...
    stats_aic = linear_regression_stats(X, y, model_aic)
    stats_bic = linear_regression_stats(X, y, model_bic)
    stats_vif = linear_regression_stats(X, y, model_vif)
