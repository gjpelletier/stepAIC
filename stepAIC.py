...
def lasso(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
        ...
        alpha_min= minimum value of range of alphas to evaluate (default=1e-4)
        alpha_max= maximum value of range of alphas to evaluate (default=1e4)
...
def ridge(X, y, **kwargs):
    ...
    **kwargs (optional keyword arguments):
    ...
    if data['verbose'] == 'on':
        ...
        ax2.set_ylabel('RMSE difference between VIF and target', color='r')
